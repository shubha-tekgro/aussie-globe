...
export default function Footer() {
  return (
    <section className='mt-96 bg-slate-100 '>
      <div className='px-4 py-10 bg-gradient-to-b from-blue to-blue-500 text-white mx-auto flex flex-col gap-6 text-center sm:px-6 md:px-8 2xl:ml-64 2xl:mr-32 '>

        <div className='flex flex-col lg:flex-row justify-between items-start gap-6'>
          <h2 className='-ml-20  2xl:text-2xl text-xl font-semibold'>
            Unlock Your Future With Our Fast & Trusted Processing
          </h2>

          <button className='bg-red text-white px-4 sm:px-6 py-3 rounded flex items-center gap-2 text-sm self-start lg:self-center hover:bg-red-600'>
        ...
        <div className='flex flex-col lg:flex-row justify-between items-start gap-6'>
          <p className='text-base sm:text-lg md:text-xl opacity-80 leading-relaxed max-w-2xl'>
            Get expert guidance for admissions, visa, and career success — hassle-free!</p>
          <button className=' px-11 py-3 rounded flex items-center border-2 bg-blue-500 text-whit hover:border-blue-500 
            text-sm self-start lg:self-center'> Talk to Our Experts!
          </button>
        </div>
      </div>
